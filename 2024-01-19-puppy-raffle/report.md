...
- [PuppyRaffle Audit Report](#puppyraffle-audit-report)
...
- [Findings](#findings)
  ...
  - [Medium](#medium)
    - [\[M-1\] Looping Through Players Array in `PuppyRaffle::enterRaffle` is a Potential DoS Vector](#m-1-looping-through-players-array-in-puppyraffleenterraffle-is-a-potential-dos-vector)
...
Using on-chain values as a randomness seed is a [well-known attack vector](https://betterprogramming.pub/how-to-generate-truly-random-numbers-in-solidity-and-blockchain-9ced6472dbdf).


**Recommended Mitigation:** Use an oracle for randomness, such as [Chainlink VRF](https://docs.chain.link/vrf/v2/introduction).
