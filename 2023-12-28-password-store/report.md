...
- [Findings](#findings)
  - [High](#high)
    - [\[H-1\] Passwords stored on-chain are visible to anyone, no matter solidity variable visibility](#h-1-passwords-stored-on-chain-are-visible-to-anyone-no-matter-solidity-variable-visibility)
...
### [H-1] Passwords stored on-chain are visible to anyone, no matter solidity variable visibility
